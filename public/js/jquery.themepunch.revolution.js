		...
		********************************/
		...
		function createThumbs(container,opt) {
			...
			container.find('>ul:first >li').each(function(i) {
							...
							bullets.append('<div class="bullet thumb" style="background-color:'+bgcolor+';position:relative;width:'+opt.thumbWidth+'px;height:'+opt.thumbHeight+'px;background-image:url('+src+') !important;background-size: 100% 100% !important;background-position:center center;"></div>');
		...
		function prepareSlides(container,opt) {
			...
			container.find('>ul:first >li >img').each(function(j) {
				...
				if (bgfit==undefined) bgfit="100% 100%";
									...
									if (nextcaption.find('iframe').length>0 || nextcaption.find('video').length>0) {
										...
										nextcaption.find('iframe').each(function() {
												...
												if (nextcaption.data('thumbimage')!=undefined && nextcaption.data('thumbimage').length>2 && nextcaption.data('autoplay')!=true && !recalled) {
													...
													nextcaption.append('<div class="tp-thumb-image" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;background-image:url('+nextcaption.data('thumbimage')+'); background-size: 100% 100% !important"></div>');
												}

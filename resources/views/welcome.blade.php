			    ...
			    <head>
			    	...
			    	<script type="text/javascript" src="{{ URL::asset('js/dist/owl.carousel.min.js') }}"></script>
			    	<script type="text/javascript" src="{{ URL::asset('js/dist/assets/owl.theme.default.css') }}"></script>
			                   ...
			                   <!--a href="#home">Home</a>
			                	...
			                	<!--div>
			                		<ul>
			                			...
			                			<li class="texto_rodape"> Endereço da Mangue </li>
			                			<li class="texto_rodape"> Botão </li>
			                			<li class="texto_rodape"> Desenvolvido por mangue tecnologia</li>
